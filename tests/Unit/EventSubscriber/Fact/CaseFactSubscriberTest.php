...
use App\EventSubscriber\Fact\CaseFactSubscriber;
use App\ServiceInterface\Fact\FactSubjectCommitterInterface;
use Doctrine\ORM\EntityManagerInterface;
use PHPUnit\Framework\TestCase;

final class CaseFactSubscriberTest extends TestCase
{
    public function testOpenedAndResolvedFactsUseCanonicalActorSubject(): void
    {
        ...
        $subscriber = new CaseFactSubscriber($entityManager, $committer);
    ...
    public function testEmailActorResolvesToCanonicalSubject(): void
    {
        ...
        (new CaseFactSubscriber($entityManager, $committer))->onOpened(
