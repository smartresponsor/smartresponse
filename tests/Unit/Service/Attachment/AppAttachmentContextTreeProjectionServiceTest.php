...
use App\Service\Attachment\AppAttachmentContextTreeProjectionService;
use PHPUnit\Framework\TestCase;
use Symfony\Component\HttpFoundation\Request;

final class AppAttachmentContextTreeProjectionServiceTest extends TestCase
{
    public function testProjectsMediaAndDocumentTaxonomy(): void
    {
        $service = new AppAttachmentContextTreeProjectionService();
