...
#[ORM\UniqueConstraint(name: 'uniq_project_type_tenant_code', columns: ['object_tenant', 'object_code'])]
#[ORM\UniqueConstraint(name: 'uniq_project_type_tenant_slug', columns: ['object_tenant', 'object_slug'])]
final class ProjectTypeEntity implements ObjectAuditedInterface, ObjectCodedInterface, ObjectIdentifiedInterface, ObjectScopedInterface, ObjectStatefulInterface, ObjectTitledInterface
{
