...
#[ORM\UniqueConstraint(name: 'uniq_project_type_tenant_code', columns: ['tenant_id', 'code'])]
#[ORM\UniqueConstraint(name: 'uniq_project_type_tenant_slug', columns: ['tenant_id', 'slug'])]
final class ProjectTypeEntity
{
