...
use App\Service\Retail\AppRetailResponseApiService;
...
#[AsController]
final class ApiRetailResponseController extends AbstractController
{
    public function __construct(
        private readonly Security $security,
        private readonly VendorRepositoryInterface $vendorRepository,
        private readonly AppRetailResponseApiService $responses,
    ) {
    }
