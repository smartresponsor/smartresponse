...
use App\Dto\Placement\AppRetailReviewFormData;
use App\Form\Placement\AppRetailReviewType;
...
final readonly class AppRetailReviewService
{
    ...
    private function handle(CrudServiceContext $context): CrudResourceContract|RedirectResponse
    {
        ...
        $data = new AppRetailReviewFormData();
        ...
        $form = $this->formFactory->create(AppRetailReviewType::class, $data);
