...
use App\Dto\Placement\Retail\RetailPlacementFulfillmentFormData;
use App\Form\Placement\Retail\RetailPlacementFulfillmentType;
...
final readonly class RetailPlacementFulfillmentNewService
{
    ...
    private function handle(CrudServiceContext $context): CrudResourceContract|RedirectResponse
    {
        ...
        $data = new RetailPlacementFulfillmentFormData();
        ...
        $form = $this->formFactory->create(RetailPlacementFulfillmentType::class, $data);
