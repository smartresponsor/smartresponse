...
use App\Form\Placement\PricingPlacementType;
...
final readonly class PricingNewService
{
    ...
    private function handle(CrudServiceContext $context): CrudResourceContract|RedirectResponse
    {
        ...
        $data = new PricingPlacementFormData();
        ...
        $form = $this->formFactory->create(PricingPlacementType::class, $data);
