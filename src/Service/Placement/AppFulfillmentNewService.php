...
use App\Form\Placement\AppFulfillmentPlacementType;
...
final readonly class AppFulfillmentNewService
{
    ...
    private function handle(CrudServiceContext $context): CrudResourceContract|RedirectResponse
    {
        ...
        $data = new AppFulfillmentPlacementFormData();
        ...
        $form = $this->formFactory->create(AppFulfillmentPlacementType::class, $data);
