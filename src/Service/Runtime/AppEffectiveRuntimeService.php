...
use App\Dto\Runtime\AppEffectiveRuntime;

final readonly class AppEffectiveRuntimeService
{
    ...
    public function resolve(string $applicationKey, string $environment): AppEffectiveRuntime
    {
        ...
        return new AppEffectiveRuntime(
            $applicationKey,
            $environment,
