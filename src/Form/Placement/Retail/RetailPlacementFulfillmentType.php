...
final class RetailPlacementFulfillmentType extends AbstractType
{
    ...
    {
        $resolver->setDefaults(['data_class' => RetailPlacementFulfillmentFormData::class, 'csrf_protection' => true]);
    }
}
