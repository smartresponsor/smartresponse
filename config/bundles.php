...
return [
    ...
    App\Navigating\NavigationBundle::class => ['all' => true],
    ...
    App\Rolling\Infrastructure\Symfony\RoleBundle::class => ['all' => true],
    ...
    App\Merchandising\MerchandisingBundle::class => ['all' => true],
];
