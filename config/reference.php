 ...
 *     },
 * }
 * @psalm-type BridgeConfig = array{
 *     defaults?: array{
 *         strict_resolution?: bool|Param, // Default: true
 *     },
 * }
 ...
 *     },
 * }
 * @psalm-type TaxatingConfig = array{
 *     database_url?: scalar|Param|null, // Default: "sqlite::memory:"
 *     postgres_dsn?: scalar|Param|null, // Default: "sqlite::memory:"
 *     postgres_user?: scalar|Param|null, // Default: ""
 *     postgres_password?: scalar|Param|null, // Default: ""
 *     mysql_dsn?: scalar|Param|null, // Default: "sqlite::memory:"
 *     mysql_user?: scalar|Param|null, // Default: ""
 *     mysql_password?: scalar|Param|null, // Default: ""
 *     fact_store_driver?: scalar|Param|null, // Default: "ledger"
 *     stripe_tax_sandbox?: bool|Param, // Default: true
 *     enable_observability?: bool|Param, // Default: true
 *     ctc?: array{
 *         wkhtmltopdf_bin?: scalar|Param|null, // Default: "wkhtmltopdf"
 *     },
 *     vat_verify?: array{
 *         mode?: scalar|Param|null, // Default: "cache-only"
 *         gateway_url?: scalar|Param|null, // Default: ""
 *     },
 *     avalara?: array{
 *         sandbox?: bool|Param, // Default: false
 *         company_code?: scalar|Param|null, // Default: "DEFAULT"
 *         username?: scalar|Param|null, // Default: ""
 *         password?: scalar|Param|null, // Default: ""
 *         base_url?: scalar|Param|null, // Default: "https://rest.avatax.com"
 *         sandbox_base_url?: scalar|Param|null, // Default: "https://sandbox-rest.avatax.com"
 *         timeout_ms?: int|Param, // Default: 1800
 *         retry_max?: int|Param, // Default: 2
 *         retry_base_ms?: int|Param, // Default: 250
 *         slo_ms?: int|Param, // Default: 900
 *     },
 *     stripe_tax?: array{
 *         api_key?: scalar|Param|null, // Default: ""
 *         base_url?: scalar|Param|null, // Default: "https://api.stripe.com"
 *         sandbox_base_url?: scalar|Param|null, // Default: "https://api.stripe.com"
 *         timeout_ms?: int|Param, // Default: 1500
 *         retry_max?: int|Param, // Default: 2
 *         retry_base_ms?: int|Param, // Default: 200
 *         slo_ms?: int|Param, // Default: 800
 *     },
 *     slo?: array{
 *         p95_ms?: int|Param, // Default: 500
 *         error_rate?: float|Param, // Default: 0.01
 *     },
 * }
 * @psalm-type IndexConfig = array{
 *     driver?: "meili"|"algolia"|Param, // Default: "meili"
 *     job?: array{
 *         connection_service_id?: scalar|Param|null, // Default: "doctrine.dbal.default_connection"
 *         table?: scalar|Param|null, // Default: "index_job"
 *         lease_second_default?: int|Param, // Default: 60
 *     },
 *     pointer?: array{
 *         connection_service_id?: scalar|Param|null, // Default: "doctrine.dbal.default_connection"
 *         table?: scalar|Param|null, // Default: "index_pointer"
 *     },
 *     outbox?: array{
 *         connection_service_id?: scalar|Param|null, // Default: "doctrine.dbal.default_connection"
 *         table?: scalar|Param|null, // Default: "index_outbox"
 *         max_attempt?: int|Param, // Default: 20
 *     },
 *     meili?: array{
 *         url?: scalar|Param|null, // Default: "%env(MEILI_URL)%"
 *         key?: scalar|Param|null, // Default: "%env(MEILI_KEY)%"
 *         prefix?: scalar|Param|null, // Default: "sr_"
 *         timeout_second?: float|Param, // Default: 5.0
 *     },
 *     algolia?: array{
 *         app_id?: scalar|Param|null, // Default: "%env(ALGOLIA_APP_ID)%"
 *         api_key?: scalar|Param|null, // Default: "%env(ALGOLIA_API_KEY)%"
 *         prefix?: scalar|Param|null, // Default: "sr_"
 *         timeout_second?: float|Param, // Default: 10.0
 *     },
 *     search_policy?: array{
 *         enabled?: bool|Param, // Default: false
 *         tenant_field?: scalar|Param|null, // Default: "tenantId"
 *         soft_deleted_field?: scalar|Param|null, // Default: "softDeleted"
 *         exclude_soft_deleted_by_default?: bool|Param, // Default: true
 *         require_tenant_by_default?: bool|Param, // Default: false
 *     },
 *     source_profile?: array<string, array{ // Default: {"product":{"table":"product","id_column":"id","updated_at_column":"updated_at","tenant_column":null,"soft_deleted_column":null,"body_json_column":"body_json"}}
 *         table?: scalar|Param|null,
 *         id_column?: scalar|Param|null, // Default: "id"
 *         updated_at_column?: scalar|Param|null, // Default: "updated_at"
 *         tenant_column?: scalar|Param|null, // Default: null
 *         soft_deleted_column?: scalar|Param|null, // Default: null
 *         body_json_column?: scalar|Param|null, // Default: "body_json"
 *     }>,
 * }
